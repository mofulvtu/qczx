...
function myfun(){
	...
	var sss = $('#centent').find('p').eq(1).val();
	alert(sss);
	var name = $("div p:first").val();
	alert(name)

//	var name = $("div p:first").value();
//	var name2 = $(".centent").val();
//	var name3 = $("div").children("p").value();
//	alert(name);
//	alert(name2);
//	alert(name3);
...
<div id="outer">
	...
	<div id="content">
		<div id="primarycontainer">
				<p style="font-size: large;font-weight: 600; color: #c70904 ;font-style: normal;height: 1.2em;margin: 1.0em 0em 0em 0em;">搜索结果</p>
			 ...
			 <c:forEach var="news" items="${newsList}" >
				<div class="post">
					...
					<div class="contentarea">
						...
						<ul class="controls">
							<li><a href="http://www.autohome.com.cn" class="printerfriendly">来源:${news.source}</a></li>
